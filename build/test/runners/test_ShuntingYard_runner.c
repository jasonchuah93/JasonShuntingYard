...
int main(void)
{
  ...
  UnityBegin();
  RUN_TEST(test_shunting_yard_should_return_0_if_the_expression_is_null, 17);
  ...
  RUN_TEST(test_2_OR_3_PLUS_4_MULTIPLY_5_MINUS_6_MINUS_10, 378);
  RUN_TEST(test_LEFT_PARENTHESIS_2_PLUS_3_RIGHT_PARENTHESIS_MULTIPLY_4, 485);
  RUN_TEST(test_2_MULTIPLY_LEFT_PARENTHESIS_THREE_PLUS_FOUR_RIGHT_PARENTHESIS, 561);
  RUN_TEST(test_NEGATIVE_2_SHOULD_RETURN_NEGATIVE_2, 637);
  RUN_TEST(test_NEGATIVE_2_PLUS_NEGATIVE_3, 675);
  RUN_TEST(test_NEGATIVE_NEGATIVE_NEGATIVE_NEGATIVE_NEGATIVE_2, 741);
  RUN_TEST(test_LEFT_PARENTHESIS_10_MULTIPLY_100_RIGHT_PARENTHESIS_DIVIDE_BY_LEFT_PARENTHESIS_LEFT_PARENTHESIS_NEGATIVE_5_MULTIPLY_6_RIGHT_PARENTHESIS_SUBTRACT_LEFT_PARENTHESIS_2_MINUS_30_RIGHT_PARENTHESIS_RIGHT_PARENTHESIS, 820);
  RUN_TEST(test_NEGATIVE_LEFT_PARENTHESIS_NEGATIVE_2_RIGHT_PARENTHESIS, 1028);
  ...
  RUN_TEST(test_operator_evaluate_should_calculate_2_PLUS_3, 1258);
